...
SyntaxInformation[Associate] = {"ArgumentsPattern" -> {_, _.}};
...
Associate[] /; Message[Associate::argt, Associate, 0, 1, 2] = $Failed;
Associate[_, _, rest__] /; Message[Associate::argt, Associate, Length@{rest} + 2, 1, 2] = $Failed;
Associate[a_ /; !AssociationQ[a], _] /; Message[Associate::invrl, a] = $Failed;
Associate[_, a_ /; !AssociationQ[a]] /; Message[Associate::invrl, a] = $Failed;
